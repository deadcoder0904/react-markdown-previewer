...
var Printing = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement('div', { style: styles, dangerouslySetInnerHTML: { __html: marked(this.props.md) } });
  }
});

module.exports = Printing;

},{"marked":28,"react":159}],161:[function(require,module,exports){
var React = require('react');
...
var Writing = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement("textarea", { style: styles, value: this.state.md, onChange: this.inputChange });
  }
});
  ...
  render: function () {
    ...
    return React.createElement(
      ...
      React.createElement(
        'div',
        { style: style },
        React.createElement(Writing, { md: this.state.md, markDown: this.markDown }),
        React.createElement(Printing, { md: this.state.md })
      )
    );
  }
});
...
},{"./components/Printing.jsx":160,"./components/Writing.jsx":161,"react":159,"react-dom":30}]},{},[162]);
